...
const ShareModal = ({ isOpen, onClose, post }) => {
  ...
  return (
    <AnimatePresence mode="wait">
      {isOpen && (
        <React.Fragment key="share-modal">
          {/* Backdrop */}
          <motion.div
            ...
            <motion.div
              ...
              className={`
                ...
                ${window.innerWidth >= 768 
                  ? 'md:max-w-md md:w-full md:rounded-2xl md:mx-4' 
                  : 'rounded-t-2xl'
                }
            ...
            >
                    ...
                    >
                      <div 
                        className={`
                          ...
                          ${hoveredOption === option.id ? 'shadow-lg ring-2 ring-offset-2' : ''}
                        `}
                        style={{
                          boxShadow: hoveredOption === option.id ? `0 0 0 3px ${option.color}30` : undefined
                        }}
                      >
                        {option.icon}
                      </div>
              ...
              <div className="p-5 pt-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    <motion.div 
                      animate={isCopied ? { rotate: 360, scale: 1.1 } : {}}
                      transition={{ duration: 0.3 }}
                      className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-gray-200 transition-all duration-200"
                    >
                      {isCopied ? (
                        <motion.svg 
                          initial={{ scale: 0 }}
              ...
              <div className="px-5 pb-5 pt-0">
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  onClick={onClose}
                  className="w-full py-3 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all duration-200"
                >
                  Cancel
                </motion.button>
              </div>
